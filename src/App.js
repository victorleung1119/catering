      ...
      <div className="background">
        <div className="bgwidget">
          <div className="container-fluid">
            <div className="row">
              <div className="col-12 col-sm-6 d-flex align-items-center justify-content-center insidewidget">
        ...
        <div className="container-fluid py-1">
          <div className="row">
            ...
            <div className="col-12 col-sm-4 p-1 d-flex align-items-center justify-content-center lilbox img-fluid ourStory">
              <h3>OUR STORY</h3>
            </div>
